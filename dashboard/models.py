...
class Company(models.Model):
    ...
    updated_by=models.ForeignKey(User, blank=True, related_name='created_by_company')
...
class Branch(models.Model):
    ...
    manager=models.ForeignKey(User, blank=True,related_name='branch_manager')
    created_by=models.ForeignKey(User, blank=True,related_name='created_by_on_branch')
    created_on=models.DateTimeField(auto_now_add=True)
    updated_on=models.DateTimeField(auto_now=True)
    updated_by=models.ForeignKey(User, blank=True,related_name='updated_by_branch')

class baseModel(models.Model):
    created_by=models.ForeignKey(User,related_name='applicationcreator', blank=True, null=True)
    created_on=models.DateTimeField(auto_now_add=True, blank=True)
    updated_on=models.DateTimeField(auto_now=True, blank=True)
    updated_by=models.ForeignKey(User, blank=True,related_name='applicationupdater', null=True)
    company=models.ForeignKey(Company, related_name='applicationcompany',null=True)
    branch=models.ForeignKey(Branch, related_name='applicationbranch',null=True)
...
class companyAccount(Bank):
    owner=models.ForeignKey(Company, related_name="company_account")
    description=models.TextField()

class personAccount(Bank):
    owner=models.ForeignKey(User, related_name='user_bank')
...
class Message(baseModel):
    ...
    sent_by=models.ForeignKey(User, related_name='message_sender')
